...
agilent_df = pd.read_csv(cwd / 'files' / 'whole_exome_agilent_1.1_refseq_plus_3_boosters.targetIntervals.bed', sep='\t', low_memory=False, header=None)
...
with open(cwd / 'files' / 'bams' / 'queries.pkl', 'wb') as f:
